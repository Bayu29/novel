...
<div class="marketplace_style_one bg-body-2 section_gap_y_bottom__1 ">
	<div class="container">
		<div class="row nft_grid__header px-0">
			<div class="col-lg-7">
				<ul class="grid__tabs">
					<li><a href="marketplace-1.html" class="active_nft__grid">NFTs  62,952</a></li>
					<li><a href="collection.html">Collections  12,846</a></li>
					<li><a href="auction.html">Auctions  54,629</a></li>
				</ul>
			</div>
			<div class="col-lg-5 d-flex justify-content-lg-end mt-lg-0 mt-3">
				<div class="select_style__one">
					<select class="select__nice" style="display: none;">
						<option data-display="Recently Listed">Recently Listed</option>
						...
						</select><div class="nice-select select__nice" tabindex="0"><span class="current">Recently Listed</span><ul class="list"><li data-value="Recently Listed" data-display="Recently Listed" class="option selected">Recently Listed</li><li data-value="1" class="option">Recently Created</li><li data-value="2" class="option">Recently Sold</li><li data-value="3" class="option">Ending Soon</li><li data-value="4" class="option">Price: Low to High</li><li data-value="5" class="option">Price: High to Low</li><li data-value="6" class="option">Oldest</li></ul></div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-3">
					...
					<div id="filter-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="filterHeadingTwo">
						<div class="accordion-body sidebar__body">
							...
							<div class="price__range">
								<input type="number" value="50" min="50" step="5">
								<span>To</span>
								<input type="number" value="70" min="70" step="5">
							</div>
				...
				<div class="accordion-item sidebar_collections__filter sidebar__filter ">
					<h2 class="accordion-header sidebar__header" id="filterHeadingThree">
						<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#filter-collapseThree" aria-expanded="true" aria-controls="filter-collapseThree">
						Collections
						</button>
					</h2>
					<div id="filter-collapseThree" class="accordion-collapse collapse show" aria-labelledby="filterHeadingThree">
						<div class="accordion-body sidebar__body">
							<form action="#">
							<div class="innner_filter__search mb-3">
								<input type="text" placeholder="Search here">
							...
							<ul>
								...
								<label>
									<span class="col__right">
										...
										<ins class="col__name">Sports</ins>
									</span>
									<input type="checkbox">
									<span class="check__circle"></span>
								</label>
								...
								<label>
									<span class="col__right">
											...
											<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<path d="M5.9248 4.2002H8.07689" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
												<path d="M7.00037 11.1999C8.28445 11.1999 9.3318 10.1779 9.3318 8.9249C9.3318 7.6719 8.28445 6.6499 7.00037 6.6499C5.71629 6.6499 4.66895 7.6719 4.66895 8.9249C4.66895 10.1779 5.71629 11.1999 7.00037 11.1999Z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
												</svg>
											</span>
										<ins class="col__name">Photography</ins>
									</span>
									<input type="checkbox">
									<span class="check__circle"></span>
								</label>
								...
								<label>
									<span class="col__right">
											...
											<svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M8.85201 6.58936C8.85201 6.58936 8.71183 7.29025 6.60915 10.0938C4.57655 12.7572 7.52031 14.7197 7.87076 15.0001H7.94085C8.36139 14.6497 13.6882 11.2854 8.85201 6.58936Z" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
										...
										<ins class="col__name">Collectibles</ins>
									</span>
									<input type="checkbox">
									<span class="check__circle"></span>
								</label>
								...
								<label>
									<span class="col__right">
											<span class="cate_icon">
											<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M11.7657 3.1001C10.0974 5.61876 6.88261 7.06354 3.53311 6.80337L1.49902 6.64284" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
												<path d="M5.23242 14.3C6.74909 11.1516 9.67159 9.34567 12.7166 9.67088L14.5658 9.87154" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
												<path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15Z" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
												</svg>
											</span>
										<ins class="col__name">Sports</ins>
									</span>
						...
						<div class="auction_card_style__two">
							...
							<div class="nft__disc">
								...
								<div class="nft__bottom">
									...
									<div class="nft__countdown"><div class="count__down countdown" data-date="2022-11-09"><div class="countdown-container days"><span class="countdown-value days-bottom">55</span><span class="countdown-heading days-top">d</span></div><div class="countdown-container hours"><span class="countdown-value hours-bottom">07</span><span class="countdown-heading hours-top">h</span></div><div class="countdown-container minutes"><span class="countdown-value minutes-bottom">16</span><span class="countdown-heading minutes-top">m</span></div><div class="countdown-container seconds"><span class="countdown-value seconds-bottom">56</span><span class="countdown-heading seconds-top">s</span></div></div></div>
								</div>
							</div>
						...
						<div class="auction_card_style__two">
							...
							<div class="nft__disc">
								...
								<div class="nft__bottom">
									...
									<div class="nft__countdown"><div class="count__down countdown" data-date="2022-10-10"><div class="countdown-container days"><span class="countdown-value days-bottom">25</span><span class="countdown-heading days-top">d</span></div><div class="countdown-container hours"><span class="countdown-value hours-bottom">07</span><span class="countdown-heading hours-top">h</span></div><div class="countdown-container minutes"><span class="countdown-value minutes-bottom">16</span><span class="countdown-heading minutes-top">m</span></div><div class="countdown-container seconds"><span class="countdown-value seconds-bottom">56</span><span class="countdown-heading seconds-top">s</span></div></div></div>
								</div>
							</div>
