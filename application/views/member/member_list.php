											...
											<tbody><?php $no = 1;
													...
													<tr>
														...
														<td style="text-align:center" width="100px">
															...
															echo '  ';
															echo anchor(site_url('member/delete/' . encrypt_url($member->member_id)), '<i class="fa fa-trash" aria-hidden="true"></i>', 'class="btn btn-danger btn-sm delete_data" Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
															?>
														</td>
													</tr>
												<?php } ?>
