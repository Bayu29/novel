											...
											<tbody><?php $no = 1;
													...
													<tr>
														...
														<td style="text-align:center" width="200px">
															...
															echo '  ';
															echo anchor(site_url('bank/delete/' . encrypt_url($bank->bank_id)), '<i class="fa fa-trash" aria-hidden="true"></i>', 'class="btn btn-danger btn-sm delete_data" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
															?>
														</td>
													</tr>
												<?php } ?>
